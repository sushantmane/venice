...
public class VeniceGrpcReadServiceImpl extends VeniceReadServiceGrpc.VeniceReadServiceImplBase {
  ...
  public VeniceGrpcReadServiceImpl(
  ...
  public void multiGet(MultiGetRequest request, StreamObserver<MultiGetResponse> streamObserver) {
    throw new UnsupportedOperationException("MultiGet operation is not supported in Venice Read Service");
  }

  @Override
  public void compute(ComputeRequest request, StreamObserver<MultiGetResponse> responseObserver) {
    throw new UnsupportedOperationException("Compute operation is not supported in Venice Read Service");
  }
