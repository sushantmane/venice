...
public class VeniceWriterFactoryTest {
  ...
  public void testVeniceWriterFactory() {
    ProducerAdapterFactory<ProducerAdapter> producerFactoryMack = mock(ProducerAdapterFactory.class);
    ProducerAdapter producerAdapterMock = mock(ProducerAdapter.class);
