...
public class ControllerRoutesTest {
  ...
  public void testGetLeaderController() throws Exception {
    ...
    Route leaderControllerRoute =
        new ControllerRoutes(false, Optional.empty(), pubSubTopicRepository, requestHandler).getLeaderController(mockAdmin);
    ...
    Route leaderControllerSslRoute =
        new ControllerRoutes(true, Optional.empty(), pubSubTopicRepository, requestHandler).getLeaderController(mockAdmin);
  ...
  public void testGetAggregatedHealthStatus() throws Exception {
    ControllerRoutes controllerRoutes = new ControllerRoutes(false, Optional.empty(), pubSubTopicRepository, requestHandler);
