...
public class LeaderFollowerPartitionStateModel extends AbstractPartitionStateModel {
  ...
  public void onBecomeLeaderFromStandby(Message message, NotificationContext context) {
    // TODO: Replace with call to Message::getLeaderTerm API
  ...
  public void onBecomeStandbyFromLeader(Message message, NotificationContext context) {
    ...
    if (replica.getCurrentTermId() != replica.getMyLastLeaderTermId()) {
      logger.fatal(
          "Leaders last term id: {} does not match with the current term id: {}. This is potentially due to a bug in the code. Throwing error for the LEADER->STANDBY state transition for replica: {}",
