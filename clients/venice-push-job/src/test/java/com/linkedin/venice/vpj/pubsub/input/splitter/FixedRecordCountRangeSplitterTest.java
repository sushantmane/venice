...
/**
 * Unit tests for {@link FixedRecordCountRangeSplitter}.
 */
public class FixedRecordCountRangeSplitterTest {
  private static final PubSubTopicRepository TOPIC_REPOSITORY = new PubSubTopicRepository();

  private FixedRecordCountRangeSplitter splitter;
  ...
  public void setUp() {
    ...
    splitter = new FixedRecordCountRangeSplitter();
  }
  ...
  public void testLargeScaleSplitting() {
    ...
    for (int i = 1; i <= 10000; i++) {
      positions[i] = ApacheKafkaOffsetPosition.of(i * 10);
  ...
  private SplitRequest createSplitRequest(long recordsPerSplit) {
    return new SplitRequest.Builder().pubSubTopicPartition(partition)
        ...
        .splitType(SplitType.FIXED_RECORD_COUNT)
