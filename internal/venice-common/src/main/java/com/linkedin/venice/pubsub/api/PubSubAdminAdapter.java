...
public interface PubSubAdminAdapter extends Closeable {
   ...
   * @throws PubSubClientException If an error occurs while attempting to retrieve the configuration or if the current
   *                               thread is interrupted while attempting to retrieve the configuration.
   */
   ...
   * @throws PubSubClientException If an error occurs while attempting to retrieve the list of topics or the current
   *                               thread is interrupted while attempting to retrieve the list of topics.
   */
   ...
   * @throws PubSubClientException If an error occurs while attempting to set the topic configuration or if the current
   *                               thread is interrupted while attempting to set the topic configuration.
   */
   ...
   * @throws PubSubClientException If an error occurs while attempting to retrieve retention settings or if the current
   *                               thread is interrupted while attempting to retrieve retention settings.
   */
